...
#<swig-pointer std::vector< double > * 7f929cd04820>
17.3020736
```
...
POLYNOMIAL_VERSION 1.2.1
_a0566012df7f0000_p_std__vectorT_double_t
17.3020736
```
...
clang -g -Isrc -Wno-sentinel /linux -I$JAVA_HOME/include/darwin -c -o  \
...
clang -g -Isrc -Wno-sentinel /x86_64-darwin19 -c -o          \
...
clang -g -Isrc -dynamiclib -Wl,-undefined,dynamic_lookup -o  \
  ...
  target/guile/example1_swig.c.o -lguile-2.2 -lgc -ltommath
...
# Compile clojure bindings:
clang++ -g -Isrc -Wno-c++11-extensions -stdlib=libc++ -std=c++17 -Wno-sentinel  \
  /linux -I$JAVA_HOME/include/darwin -c -o target/clojure/polynomial_swig.cc.o  \
...
# Compile ruby bindings:
clang++ -g -Isrc -Wno-c++11-extensions -stdlib=libc++ -std=c++17 -Wno-sentinel  \
  /x86_64-darwin19 -c -o target/ruby/polynomial_swig.cc.o                       \
...
clang++ -g -Isrc -Wno-c++11-extensions -stdlib=libc++ -std=c++17 -dynamiclib  \
  ...
  target/native/polynomial.o target/guile/polynomial_swig.cc.o -lguile-2.2    \
  -lgc -ltommath                                                            
...
# Compile clojure bindings:
clang++ -g -Isrc -Wno-c++11-extensions -stdlib=libc++ -std=c++17 -Wno-sentinel  \
  /linux -I$JAVA_HOME/include/darwin -c -o                                      \
...
# Compile ruby bindings:
clang++ -g -Isrc -Wno-c++11-extensions -stdlib=libc++ -std=c++17 -Wno-sentinel  \
  /x86_64-darwin19 -c -o target/ruby/polynomial_v2_swig.cc.o                    \
...
clang -g -Isrc -dynamiclib -Wl,-undefined,dynamic_lookup -o  \
  ...
  target/guile/tommath_swig.c.o -lguile-2.2 -lgc -ltommath 
